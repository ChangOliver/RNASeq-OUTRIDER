...
run.OUTRIDER <- function(countDir, resDir, case){
...
outriderDir <- paste0(resDir, "/OUTRIDER")
...
write.csv(odsResult, paste0(outriderDir, "/OUTRIDER_result.csv"), row.names = FALSE)
